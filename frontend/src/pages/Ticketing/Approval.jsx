...
import { checkUserRole, getImageUrl, getTicketStatus, todayDateandTime } from "../../utils/helper";
  ...
  return (
    <div className="min-h-screen dark:bg-[#101828] p-6">
      ...
      <div className="rounded-lg border border-gray-300 dark:border-gray-700 p-4 mb-4 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 ms-2">
      ...
      {(tickets.ticket_status == CONSTANTS.OPEN && hasAdminRole) && (
